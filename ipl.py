...
st.markdown("<h1 style='text-align: center; color:BLACK;'> IPL Score Predictor 2023 </h1>", unsafe_allow_html=True)
...
st.markdown(
    f"""
         <style>
         .stApp {{
             background-image: url("https://img1.hscicdn.com/image/upload/f_auto/lsci/db/PICTURES/CMS/309800/309830.6.jpg");
...
batting_team = st.selectbox('Select the Batting Team ', (
      'Chennai Super Kings', 'Delhi capital', 'Kings XI Punjab', 'Kolkata Knight Riders', 'Mumbai Indians',
